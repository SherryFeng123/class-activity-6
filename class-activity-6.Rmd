...
#Wrangle data, removes first two rows
DF1 <- DF1[-c(1:2),]  
```
...
names(DF3) <- c("longitude", "latitude", "cluster") #c() stands for concatonate and it creates a vector of anything, in this case a vector of names.
...
plot(DF3$longitude, DF3$latitude, xlab = "Longitude", ylab = "Latitude",
   xlim = c(-200, 200),
   ylim = c(-200, 200),		 
   main = "Scatterplot")
```
